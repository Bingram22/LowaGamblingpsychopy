...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/u1984094/Documents/submarine/LowaGamblingpsychopy/lowagambling_lastrun.py',
...
instrtext = visual.TextStim(win=win, name='instrtext',
    text='Welcome to this experiment! In front of you are four cards. Your task is to select any one card. Upon flipping the card, you will receive a corresponding reward, which will be added to your loan of 2000 pounds. Note that sometimes you might also face certain fines, which will be deducted from your total earnings. Your goal is to earn as much income as possible.\n\nA, B, C, D correspond to the keys 1, 2, 3, 4 on the keyboard.\n\nPlease press the spacebar to continue.',
...
# set up handler to look after randomisation of cost etc
...
for thisTrial in trials:
    ...
    feedback_text = "You won {} pounds, but you lost {} pounds".format(current_win, current_loss)
